      ...
      cz.prompt([
        {
          ...
          type: 'input',
          name: 'scope',
          message: '请输入本次commit的影响范围(选填): (Denote the scope of this change (JSX, Reducer, Service, etc.)\n'
        }, {
          type: 'input',
          name: 'subject',
          message: '请概括本次commit的主题(必填): (Write a short, imperative tense description of the change)\n'
        }, {
          type: 'editor',
          name: 'body',
